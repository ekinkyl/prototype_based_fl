...
class adcol_resnet10(nn.Module):
    def __init__(self, num_classes=10):
        super(adcol_resnet10, self).__init__()
        # 1-channel for MNIST
        base_resnet = resnet10(in_channels=1, num_classes=num_classes)
        # Separate features and classifier for FedPall
