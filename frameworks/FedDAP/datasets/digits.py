...
from datasets.utils.federated_dataset import FederatedDataset, partition_digits_domain_skew_loaders, partition_label_skew_loaders
...
class FedLeaDigits(FederatedDataset):
    ...
    def get_data_loaders(self, selected_domain_list=[]):
        ...
        traindls, testdls, _ = partition_label_skew_loaders(train_dataset_list[0].dataset, test_dataset_list[0].dataset, self)
