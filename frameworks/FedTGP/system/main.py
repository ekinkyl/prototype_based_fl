...
def run(args):
    ...
    for i in range(args.prev, args.times):
        ...
        # ----- MNIST-specific heterogeneous families (1-channel, 28x28) -----
        elif args.model_family == "HtFE3_MNIST":
            # Same heterogeneity pattern as HtFE3 (resnet10/18/34)
            # but using local resnet.py which supports in_channels=1 for MNIST
            args.models = [
                'resnet10(in_channels=1, num_classes=args.num_classes)',
                'resnet18(in_channels=1, num_classes=args.num_classes)',
                'resnet34(in_channels=1, num_classes=args.num_classes)',
            ]
