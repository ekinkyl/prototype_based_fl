...
class FedProtoAdapter(FrameworkAdapter):
    def __init__(self, workspace_root: Path):
        self.repo_path = workspace_root / "frameworks" / "FedProto"
    ...
    def setup_data_path(self, shared_data_path: Path) -> None:
        """Create a symlink/junction for data directory so FedProto uses shared datasets."""
    ...
    def build_cli_args(self, global_config: dict, overrides: dict) -> list[str]:
        args = [
            ...
            "--train_ep", str(global_config.get("local_epochs", 5)),
            ...
            "--num_classes", str(global_config.get("num_classes", 10)),
        ]
